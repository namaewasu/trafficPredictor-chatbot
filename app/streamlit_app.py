            ...
            with st.spinner("Modeller yükleniyor..."):
                if load_models():
                    ...
                    if gemini_api_key and st.session_state.gemini_bot:
                        import google.generativeai as genai; genai.configure(api_key=gemini_api_key); st.session_state.gemini_bot.model = genai.GenerativeModel("gemini-1.5-flash"); st.session_state.gemini_bot._api_key = gemini_api_key; print("✅ Gemini API anahtari set edildi!")
